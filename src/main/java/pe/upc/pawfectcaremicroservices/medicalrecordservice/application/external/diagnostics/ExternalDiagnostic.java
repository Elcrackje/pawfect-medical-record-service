...
public class ExternalDiagnostic {
    ...
    public boolean existsDiagnosticById(Long diagnosticId) {
        try {
            restTemplate.getForObject("https://pawfect-gateway-service.azurewebsites.net/diagnostic-service/api/v1/diagnostics/{diagnosticId}", Object.class, diagnosticId);
            return true;
